...
const Contact = () => {
  return (
    <div ame='contact' className='bg-[#0a192f] w-full h-screen flex justify-center items-center p-4'>
        <form method='POST' action="https://getform.io/f/5340dc1e-d54e-4090-bbef-a28aabe268bb" className='flex flex-col max-w-[600px] w-full'>
            ...
            <button type='submit' className='text-white border-2 hover:border-orange-600 hover:bg-orange-600 px-4 py-3 my-8 mx-auto flex items-center'>Let's collabrate</button>
        </form>
    </div>
  )
}
