  ...
  return (
    <div name='home' className='w-full h-screen bg-[#0a192f]'>
        ...
        <div className='max-w-[1080px] mx-auto px-8 flex flex-col justify-center h-full'>
            ...
            <h3 className='text-4xl sm:text-7xl font-bold text-[#8892ba]'>personal website</h3>
            ...
            <div>
                <button className='group text-white font-bold border-2 px-6 py-3 my-2 flex items-center hover:bg-orange-600 hover:border-white'>
                    view work
